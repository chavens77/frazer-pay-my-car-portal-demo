...
Build the private source project, replace this repository's `index.html` and `assets` directory with the new contents of its `build` directory, then push to `main`. GitHub Pages publishes from the repository root.
